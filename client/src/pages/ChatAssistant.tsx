  ...
  return (
      <div className="flex flex-col h-full max-w-4xl mx-auto">
        <div className="flex-1 overflow-hidden flex flex-col">
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 px-4 py-2 pb-4 pt-2 z-20 composer-container input-area initial-load border-t-4 border-blue-500">
            <div className="max-w-4xl mx-auto px-2">
              ...
              <div 
                className="bg-white dark:bg-gray-800 p-3 pb-2 rounded-3xl border-2 border-blue-500 shadow-sm flex flex-col gap-1 mb-2"
                ref={composerRef}
                onFocus={() => {
