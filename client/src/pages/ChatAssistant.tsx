    ...
    <MathJaxContext config={mathJaxConfig}>
      <div className="flex flex-col h-full max-w-4xl mx-auto">
        <div className="flex-1 overflow-hidden flex flex-col">
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 px-4 py-2 pb-0 z-50 composer-container input-area">
            <div className="max-w-4xl mx-auto">
              ...
              <div 
                className="bg-white dark:bg-gray-800 p-3 pb-2 rounded-3xl border border-gray-200 shadow-sm flex flex-col gap-2"
                ref={composerRef}
                onFocus={() => {
              ...
              <div className="text-xs text-gray-500 text-center mb-0 pb-0">
