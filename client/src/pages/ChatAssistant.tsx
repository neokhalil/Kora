...
const ChatAssistant: React.FC = () => {
  ...
  // Ajuster uniquement la hauteur du textarea sans auto-scroll
  useEffect(() => {
    ...
    // Ne pas faire d'auto-scroll automatique lors des messages
    // Laissons l'utilisateur contrôler le défilement manuellement
  ...
  return (
      <div className={`flex flex-col h-full max-w-4xl mx-auto ${isMobileDevice ? 'with-pwa-banner' : ''}`}>
        {/* Bannière d'installation PWA (uniquement sur mobile) */}
        {isMobileDevice && <InstallPWAPrompt fixedPositionTop={56} />}
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 px-4 py-2 pb-4 pt-2 z-20 composer-container input-area initial-load">
            ...
            {/* Message d'information visible sous la zone de saisie - déplacé en dehors du composer */}
            <div className="text-xs text-gray-500 text-center mt-1 w-full footer-message px-4 max-w-4xl mx-auto">
