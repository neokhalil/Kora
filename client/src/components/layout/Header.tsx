      ...
      <div className="flex items-center justify-between px-4 h-full">
        ...
        <div className="flex items-center">
          <button 
            ...
            className={`menu-toggle-button flex items-center justify-center h-10 w-10 p-0 rounded-full transition-colors ${isMenuOpen ? 'menu-open bg-black' : 'bg-transparent'}`}
          >
            {isMenuOpen ? (
              <X className="h-5 w-5 text-white" strokeWidth={2.5} />
            ) : (
              <div className="hamburger-lines flex flex-col space-y-1.5">
